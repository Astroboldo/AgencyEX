			...
			<section class="ms ls page_models models_portrait gorizontal_padding section_padding_70">
				<div class="container-fluid">
					<div class="row boxed-padding bottommargin_40">
                        ...
                        <div class="col-lg-5">
                            Informamos aos nossos modelos que esta página não é utilizada por nossas lojas e marcar parceiras para a pesquisa de modelos para trabalho. Apenas para a visualização simplicita de alguns de nossos modelos.
                        </div>
					</div>
